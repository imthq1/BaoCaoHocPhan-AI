...
def predict_category(resume_text):
    ...
    # Chuyển sang vector số để máy có thể hiểu
...
rf_classifier_categorization = pickle.load(open(os.path.join(models_folder, 'rf_classifier_categorization.pkl'), 'rb'))
tfidf_vectorizer_categorization = pickle.load(open(os.path.join(models_folder, 'tfidf_vectorizer_categorization.pkl'), 'rb'))
rf_classifier_job_recommendation = pickle.load(open(os.path.join(models_folder, 'rf_classifier_job_recommendation.pkl'), 'rb'))
tfidf_vectorizer_job_recommendation = pickle.load(open(os.path.join(models_folder, 'tfidf_vectorizer_job_recommendation.pkl'), 'rb'))
...
def pred():
    if 'resume' not in request.files:
        return render_template('resumes.html', message="Vui lòng tải file CV")
    ...
    if filename.endswith('.pdf'):
        ...
        return render_template('resumes.html', message="File không hợp lệ! Hãy upload file PDF hoặc TXT.")
    ...
    return render_template('resumes.html', predicted_category=predicted_category,recommended_job=recommended_job,
